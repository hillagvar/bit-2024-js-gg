...
class Triangle {
    constructor (public _krastineA: number, public _krastineB: number, public _krastineC: number) {
    }

    set krastineA(a: number) {
    ...
    private patikrinimas(a : number, b: number, c: number) : boolean {
