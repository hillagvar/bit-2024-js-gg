...
// if (ivestiMetai < pirmosiosZaidynes) {
...
let firstOlympics = 1896;

function olympicYear(year) {
    if (year >= firstOlympics && year % 4 === 0) {
        console.log(`Metai olimpiniai, zaidyniu numeris: ${(year-firstOlympics)/4 + 1}`);
    } else {
        console.log("Metai ne olimpiniai");
    }
}

olympicYear(process.argv[2]);
